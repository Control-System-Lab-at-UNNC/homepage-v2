...
title: Omnicopter Control Research

# description [Optional]: Short description displayed on the project card
description: A hardware-based research project for fully-actuated 6-DoF aerial vehicles
...
image: assets/omnicopter_banner.svg
...
We have built such a system in last summer SEP, this project was awarded as FIRST price in 2025 UG student research showcase
...
### ⚠️ Practical issues (compared to ETH-style)

- Less standardized than the ETH/PX4-style reference design.
- Geometry and actuator directions must be modelled very carefully.
...
### 📌 Why the Lynchpin-style config is useful for us
...
The Omnicopter can be modelled as a rigid body with six controllable degrees of freedom. The key object is the **allocation matrix** $M$:
...
5. **Awesome Tech Designs — Omnicopter taxonomy and examples** <https://github.com/bpodchezertsev/awesome-tech-designs/blob/main/Omnicopter.md>
...
4. **Fetching Omnicopter** <https://www.youtube.com/watch?v=0gR1ekapOAE>
